 ...
 * single {@link CollisionLayer}. The layer defines which other layers it collides or overlaps with.
 * <p>
 * If a layer <strong>collides</strong> with another layer, all colliders belonging to the first layer are blocked from
 * collision boundaries of the second layer. Similarly, if layer is set to
 ...
 * <p>
 * In other words: Each layer defines separately which other layers it treats as solid and from which layers it wants
 * overlap events.
 */
@Slf4j
