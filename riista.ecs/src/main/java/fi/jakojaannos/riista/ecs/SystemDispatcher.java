...
import fi.jakojaannos.riista.ecs.dispatcher.SystemDispatcherBuilderImpl;
...
public interface SystemDispatcher extends AutoCloseable {
     ...
     * everything with the {@link fi.jakojaannos.riista.ecs.annotation.DisabledByDefault @DisabledByDefault}
     * annotation.
     *
