...
public class SkeletalMeshLoader extends MeshLoader<SkeletalMesh> {
    ...
    public Optional<SkeletalMesh> load(final Path path, final BitMask<AssimpProcess> flags) {
        ...
        final var processedMeshes = new MeshImpl[numMeshes];
        ...
        if (rootNode != null) {
            ...
            return Optional.of(new SkeletalMeshImpl(animations, processedMeshes));
        } else {
    ...
    protected MeshImpl processMesh(
            final AIMesh mesh,
        ...
        return new MeshImpl(this.backend,
