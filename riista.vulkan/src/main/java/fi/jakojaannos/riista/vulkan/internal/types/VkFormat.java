...
public enum VkFormat {
    ...
    R8_UNORM(VK_FORMAT_R8_UNORM, Byte.BYTES),
    R8_SNORM(VK_FORMAT_R8_SNORM, Byte.BYTES),
    R8_USCALED(VK_FORMAT_R8_USCALED, Byte.BYTES),
    R8_SSCALED(VK_FORMAT_R8_SSCALED, Byte.BYTES),
    R8_UINT(VK_FORMAT_R8_UINT, Byte.BYTES),
    R8_SINT(VK_FORMAT_R8_SINT, Byte.BYTES),
    R8_SRGB(VK_FORMAT_R8_SRGB, Byte.BYTES),
