...
public record RendererRecorder(
    ...
    public void setWriteState(final PresentableState state) {
        ...
        ((ParticleRendererRecorder) this.particles).setWriteState(state);
    }

    public RendererRecorder() {
        this(new DebugRendererRecorder(),
             new MeshRendererRecorder(),
             new UiRendererRecorder(),
             new ParticleRendererRecorder());
    }
}
