...
import fi.jakojaannos.konna.vulkan.device.SwapchainSupportDetails;
import fi.jakojaannos.konna.vulkan.types.VkFormat;
import fi.jakojaannos.konna.vulkan.types.VkImageAspectFlags;
import fi.jakojaannos.konna.vulkan.window.Window;
import fi.jakojaannos.konna.vulkan.window.WindowSurface;
