...
import fi.jakojaannos.konna.vulkan.command.GPUQueue;
import fi.jakojaannos.konna.vulkan.device.DeviceContext;
import fi.jakojaannos.konna.vulkan.memory.GPUMemory;
import fi.jakojaannos.konna.vulkan.types.VkFormat;
import fi.jakojaannos.konna.vulkan.types.VkImageTiling;
import fi.jakojaannos.konna.vulkan.types.VkImageUsageFlags;
...
public class GPUImage implements AutoCloseable {
    ...
    public GPUImage(
            ...
            final BitMask<VkImageUsageFlags> usage,
    ...
    public GPUImage(
        ...
        this.handle = createImage(deviceContext,
                                  ...
                                  this.format,
                                  tiling,
                                  new BitMask<>(VK_IMAGE_USAGE_TRANSFER_DST_BIT | usage.mask()));
        this.memory = allocateMemory(this.handle, deviceContext, memoryProperties);
        this.memory.bindImage(this.handle, 0);
    ...
    private static long createImage(
            ...
            final VkFormat format,
            final VkImageTiling tiling,
            final BitMask<VkImageUsageFlags> usageFlags
    ) {
