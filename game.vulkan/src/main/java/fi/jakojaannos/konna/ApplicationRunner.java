...
public class ApplicationRunner implements AutoCloseable {
    ...
    public void run() {
        ...
        final var avgTimePerTick = totalTime / (double) timeManager.getCurrentGameTime();
        final var avgTicksPerSecond = timeManager.getCurrentGameTime() / totalTimeSeconds;
        ...
        LOG.info("\tTicks:\t\t{}", timeManager.getCurrentGameTime());
